<template>
            ...
            <form class="register-area">
                ...
                <div class="login-input">
                    ...
                    <div class="name-block">
                        <div>姓名</div>
                        <input type="text" placeholder="請輸入姓名" maxlength="30">
                    </div>
                    <div class="phone-block">
                        <div>電話</div>
                        <input type="tel" placeholder="請輸入電話號碼" maxlength="20">
                    </div>

                    <div class="email-block">
                        <div>帳號</div>
                        <input type="email" placeholder="請輸入Email帳號" maxlength="30" autocomplete="username">
                    </div>
                    <div class="pwd-block">
                        <div>密碼</div>
                        <input type="password" placeholder="請輸入密碼" maxlength="25" autocomplete="current-password">
                        <span class="material-icons vision">visibility_off</span>
                    </div>
                    ...
                    <div class="register-submit">註冊</div>
                </div>
                ...
                <div>
                    ...
                    <div class="circle-container">
                        <a href="/front/member/googleLogin"><img src="/images/google-logo.svg" alt="google-logo"></a>
                    </div>
                    <div class="circle-container">
  ...
  export default {
  name: 'register', // 使用多單詞名稱以符合 vue/multi-word-component-names
  components: {
    Header
  }
}
...
.login-area div div input[type="email"], .register-area div div input[type="email"]
	{
	outline: none;
	border: none;
	box-shadow: none;
...
.login-area div div input[type="password"], .register-area div div input[type="password"]
	{
...
.login-area div div input[type="text"], .register-area div div input[type="text"]
	{
	-webkit-appearance: none;
	-moz-appearance: none;
	appearance: none;
...
.login-area div div input[type="email"]::placeholder, .register-area div div input[type="email"]::placeholder
	{
	color: #FFFFFF2E;
	/* font-style: italic; */
	font-size: 1em;
...
.login-area div div input[type="password"]::placeholder, .register-area div div input[type="password"]::placeholder
	{
	color: #FFFFFF2E;
	/* font-style: italic; */
	font-size: 0.8em;
...
.login-area div span a, .register-area div span a {
	color: white;
...
.login-area div span a span, .register-area div span a span {
...
.login-area div span.separator, .register-area div span.separator {
	height: 1em;
